          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                {else}
                <a id="pdf-{$con.uid|escape:'htmlall':'UTF-8'}" class="btn btn-info" role="button"  href="http://devfactura.in/api/publica/cfdi33/{$con.uid|escape:'htmlall':'UTF-8'}/pdf">Documento PDF</a>
                <a id="xml-{$con.uid|escape:'htmlall':'UTF-8'}" class="btn btn-default" href="http://devfactura.in/api/publica/cfdi33/{$con.uid|escape:'htmlall':'UTF-8'}/xml">Documento XML</a>
                {/if}
              </td>
              <td>
                {if $con.status eq 'cancelada'}
